              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Input
                    value={textColor}
                    onChange={(e) => setTextColor(e.target.value)}
                    className="h-8 text-xs font-mono flex-1 rounded-md"
                  />
                </div>
              </div>
            </section>
          ...
          {matchesFilter("layout", "flex", "display", "align", "justify", "gap", "direction") && (
            <section className="p-3.5 space-y-2.5 border-b border-border/50">
              ...
              <div className="space-y-1">
                ...
                >
                  <TabsList className="w-full h-8 bg-secondary/80 p-0.5 rounded-md">
                    <TabsTrigger value="flex" className="flex-1 text-[11px] h-7 rounded">
                      Flex
                    </TabsTrigger>
                    <TabsTrigger value="block" className="flex-1 text-[11px] h-7 rounded">
                      Block
                    </TabsTrigger>
                  </TabsList>
                </Tabs>
              ...
              {display === "flex" && (
                <>
                  <div className="space-y-1">
                    ...
                    >
                      <TabsList className="w-full h-8 bg-secondary/80 p-0.5 rounded-md">
                        <TabsTrigger value="column" className="flex-1 text-[11px] h-7 rounded gap-1">
                          <Rows className="size-3.5" /> Column
                        </TabsTrigger>
                        <TabsTrigger value="row" className="flex-1 text-[11px] h-7 rounded gap-1">
